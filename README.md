# 🎩 ChapeauNoir — Bot WhatsApp V2

Assistant WhatsApp spécialisé en **hacking éthique**, multi-connexion, par **Mcamara**.
Basé sur [Baileys](https://github.com/WhiskeySockets/Baileys). Connexion par **code d'appairage**.

📡 **Chaîne WhatsApp:** https://whatsapp.com/channel/0029Vb7Bk6jEVccC46JZL92T
...
Ouvre http://localhost:3000, entre ton numéro au format international (ex: `224661817807`).
...
*🎩 ChapeauNoir V2 — Créé par Mcamara*
